import show_diagram_3 as show_diagram_3
import show_diagram as show_diagram
import random 
import sys
...
def build_curve(l, m, D=3, last=0):
    ...
    if l < 5:
        ...
        if p is None:
            print("Шаг 1: Для заданного l неудалось найти p")
            return None
    else: 
    ...
    if data is None:
        ...
        if diagram_flag == "1":
            ...
            with open("points.txt", "w", encoding="UTF-8") as f:
                ...
                lst.sort()
            print(lst)
            show_diagram_3.plot_curve_from_file("points.txt", B, p, Q)
            # show_diagram.plot_curve(B, p, Q)
